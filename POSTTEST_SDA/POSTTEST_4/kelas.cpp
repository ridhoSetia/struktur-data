...
//   Node *prev = state.daftarKamar.tail;

//   do {
//       if (target->data.no_kamar == no_kamar) break;
//       prev = target;
//       target = target->next;
//   } while (target != state.daftarKamar.head);

//   if (target->data.no_kamar != no_kamar) {
//     state.pesanInfo =
...
//     } else if (target == state.daftarKamar.head) { // Hapus head
//         state.daftarKamar.head = target->next;
//         state.daftarKamar.tail->next = state.daftarKamar.head;
//     } else if (target == state.daftarKamar.tail) { // Hapus tail
//         state.daftarKamar.tail = prev;
//         prev->next = state.daftarKamar.head;
